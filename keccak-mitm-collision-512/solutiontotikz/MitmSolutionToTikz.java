        ...
        {       
          ...
          for (int j = 0; j < 5; j++)
          {
            if (mitmSolution.Cond[j][k][0] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(0%5+3*j)%5][0%5]+64)%64)+((0%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-0%5)+7+0.5)+") {\\textbf{\\Large 1}};\n";             
            if (mitmSolution.Cond[j][k][1] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(1%5+3*j)%5][1%5]+64)%64)+((1%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-1%5)+7+0.5)+") {\\textbf{\\Large 0}};\n";
            if (mitmSolution.Cond[j][k][2] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(2%5+3*j)%5][2%5]+64)%64)+((2%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-2%5)+7+0.5)+") {\\textbf{\\Large 0}};\n";             
            if (mitmSolution.Cond[j][k][3] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(4%5+3*j)%5][4%5]+64)%64)+((4%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-4%5)+7+0.5)+") {\\textbf{\\Large 1}};\n";
