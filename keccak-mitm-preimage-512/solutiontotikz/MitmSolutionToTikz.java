...
public class MitmSolutionToTikz {
  ...
  public String generate() {
    ...
    for (int round = 0; round < mitmSolution.Rounds+1; round++) {
      ...
      output += " \\node[align=center] at ("+(-2)+","+(25*(mitmSolution.Rounds-round)+20.5)+") [scale=1.5]{\\textbf{\\huge $A^{("+(round+1)+")}$}};\n";
       ...
       if ( round != mitmSolution.Rounds) {
        ...
        output += "\\fill[color="+RedColor+"] ("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+15)+")  rectangle ++(1,1);\n";
        output += "\\draw("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
        output += " \\node[align=center] at ("+(6*31+4+2.5)+","+(25*(mitmSolution.Rounds-round)+15.4)+") {\\textbf{\\huge - "+(consumered)+"}};\n";
       ...
       {       
        ...
        output += "\\fill[color="+RedColor+"] ("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+13)+")  rectangle ++(1,1);\n";
        output += "\\draw("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+13)+") grid ++(1,1);\n";
        output += " \\node[align=center] at ("+(6*31+4+2.5)+","+(25*(mitmSolution.Rounds-round)+13.4)+") {\\textbf{\\huge - "+(consumered)+"}};\n";
      }
      // DB after theta
      if ( round != mitmSolution.Rounds) {
          ...
          for (int i = 0; i < 5; i++)
            for (int j = 0; j < 5; j++) 
            {
              if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 0)
                output += "\\fill[color="+WhiteColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+7)+") rectangle ++(1,1);\n";
              if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                output += "\\fill[color="+RedColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+7)+") rectangle ++(1,1);\n";
              if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                output += "\\fill[color="+BlueColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+7)+") rectangle ++(1,1);\n";
              if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                output += "\\fill[color="+PurpleColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+7)+") rectangle ++(1,1);\n";
              if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                output += "\\fill[color="+GrayColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+7)+") rectangle ++(1,1);\n";
            }
        }
        for (int k = 0; k < 32; k++) {
        ...
        output += "\\fill[color="+RedColor+"] ("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+9)+")  rectangle ++(1,1);\n";
        output += "\\draw("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+9)+")  grid ++(1,1);\n";
        output += " \\node[align=center] at ("+(6*31+4+2.5)+","+(25*(mitmSolution.Rounds-round)+9.4)+") {\\textbf{\\huge - "+(consumered)+"}};\n";
      }
	...
	if (mitmSolution.dom[0][k]==1)
        {
	  output += "\\node[align=center] at ("+(6*((k-rho[3][0]+64)%32)+3+0.5)+","+(18+4+0.5)+") {\\textbf{\\Large $m$}};\n";
          output += "\\node[align=center] at ("+(6*((k-rho[3][0]+64)%32)+3+0.5)+","+(18+1+0.5)+") {\\textbf{\\Large $m$}};\n";
          output += "\\node[align=center] at ("+(6*((k-rho[0][2]+64)%32)+0+0.5)+","+(18+2+0.5)+") {\\textbf{\\Large $m$}};\n";
          output += "\\node[align=center] at ("+(6*((k-rho[0][2]+64)%32)+0+0.5)+","+(18+4+0.5)+") {\\textbf{\\Large $m$}};\n";
        }
        if (mitmSolution.dom[1][k]==1)
        {
	  output += "\\node[align=center] at ("+(6*((k-rho[4][1]+64)%32)+4+0.5)+","+(18+3+0.5)+") {\\textbf{\\Large $m$}};\n";
          output += "\\node[align=center] at ("+(6*((k-rho[4][1]+64)%32)+4+0.5)+","+(18+0+0.5)+") {\\textbf{\\Large $m$}};\n";
          output += "\\node[align=center] at ("+(6*((k-rho[1][3]+64)%32)+1+0.5)+","+(18+1+0.5)+") {\\textbf{\\Large $m$}};\n";
          output += "\\node[align=center] at ("+(6*((k-rho[1][3]+64)%32)+1+0.5)+","+(18+3+0.5)+") {\\textbf{\\Large $m$}};\n";
        }
      }
      output += "\n";
    ...
    if (round == -1) {
          ...
          for (int i = 0; i < 5; i++)
            for (int j = 0; j < 5; j++) 
            {
              if (mitmSolution.Pi_init[i][j][k][0] == 0 & mitmSolution.Pi_init[i][j][k][1] == 0 & mitmSolution.Pi_init[i][j][k][2] == 0)
                output += "\\fill[color="+WhiteColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+18)+") rectangle ++(1,1);\n";
              if (mitmSolution.Pi_init[i][j][k][0] == 0 & mitmSolution.Pi_init[i][j][k][1] == 1 & mitmSolution.Pi_init[i][j][k][2] == 1)
                output += "\\fill[color="+RedColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+18)+") rectangle ++(1,1);\n";
              if (mitmSolution.Pi_init[i][j][k][0] == 1 & mitmSolution.Pi_init[i][j][k][1] == 1 & mitmSolution.Pi_init[i][j][k][2] == 0)
                output += "\\fill[color="+BlueColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+18)+") rectangle ++(1,1);\n";
              if (mitmSolution.Pi_init[i][j][k][0] == 0 & mitmSolution.Pi_init[i][j][k][1] == 1 & mitmSolution.Pi_init[i][j][k][2] == 0)
                output += "\\fill[color="+PurpleColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+18)+") rectangle ++(1,1);\n";
              if (mitmSolution.Pi_init[i][j][k][0] == 1 & mitmSolution.Pi_init[i][j][k][1] == 1 & mitmSolution.Pi_init[i][j][k][2] == 1)
                output += "\\fill[color="+GrayColor+"] ("+(6*((k-rho[(i+3*j)%5][i]+64)%32)+((i+3*j)%5))+","+(25*(mitmSolution.Rounds-round)+(4-i)+18)+") rectangle ++(1,1);\n";
            }
        }
        for (int k = 0; k < 32; k++) 
        { 
	  ...
	  if (mitmSolution.Pi_init[0][0][k][0] == 1 & mitmSolution.Pi_init[0][0][k][1] == 1 & mitmSolution.Pi_init[0][0][k][2] == 0) {
          ...
          if (mitmSolution.Pi_init[0][1][k][0] == 0 & mitmSolution.Pi_init[0][1][k][1] == 1 & mitmSolution.Pi_init[0][1][k][2] == 1) {
            allred ++;
            output += "\\draw[line width=2pt, color=red]("+(6*((k-rho[3][0]+64)%32)+3)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.Pi_init[0][1][k][0] == 1 & mitmSolution.Pi_init[0][1][k][1] == 1 & mitmSolution.Pi_init[0][1][k][2] == 0) {
            allblue ++;
            output += "\\draw[line width=2pt, color=blue]("+(6*((k-rho[3][0]+64)%32)+3)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.Pi_init[0][2][k][0] == 0 & mitmSolution.Pi_init[0][2][k][1] == 1 & mitmSolution.Pi_init[0][2][k][2] == 1) {
            allred ++;
            output += "\\draw[line width=2pt, color=red]("+(6*((k-rho[1][0]+64)%32)+1)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.Pi_init[0][2][k][0] == 1 & mitmSolution.Pi_init[0][2][k][1] == 1 & mitmSolution.Pi_init[0][2][k][2] == 0) {
            allblue ++;
            output += "\\draw[line width=2pt, color=blue]("+(6*((k-rho[1][0]+64)%32)+1)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.Pi_init[0][4][k][0] == 0 & mitmSolution.Pi_init[0][4][k][1] == 1 & mitmSolution.Pi_init[0][4][k][2] == 1) {
            allred ++;
            output += "\\draw[line width=2pt, color=red]("+(6*((k-rho[2][0]+64)%32)+2)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.Pi_init[0][4][k][0] == 1 & mitmSolution.Pi_init[0][4][k][1] == 1 & mitmSolution.Pi_init[0][4][k][2] == 0) {
            allblue ++;
            output += "\\draw[line width=2pt, color=blue]("+(6*((k-rho[2][0]+64)%32)+2)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
            
        }

      output += "\\fill[color="+RedColor+"] ("+(6*31+4+2)+","+(25*(mitmSolution.Rounds-round)+21)+")  rectangle ++(1,1);\n";
      output += "\\draw("+(6*31+4+2)+","+(25*(mitmSolution.Rounds-round)+21)+")  grid ++(1,1);\n";
      output += " \\node[align=center] at ("+(6*31+4+4.2)+","+(25*(mitmSolution.Rounds-round)+21.4)+") {\\textbf{\\huge = "+(allred*2)+"}};\n";
      output += "\\fill[color="+BlueColor+"] ("+(6*31+4+2)+","+(25*(mitmSolution.Rounds-round)+19)+")  rectangle ++(1,1);\n";
      output += "\\draw("+(6*31+4+2)+","+(25*(mitmSolution.Rounds-round)+19)+") grid ++(1,1);\n";   
      output += " \\node[align=center] at ("+(6*31+4+4.1)+","+(25*(mitmSolution.Rounds-round)+19.4)+") {\\textbf{\\huge = "+(allblue*2)+"}};\n";
      //output += " \\node[align=center] at ("+(-2)+","+(25*(mitmSolution.Rounds-round)+13.5)+") [scale=1.5] {\\textbf{\\huge $D^{("+(round+1)+")}$}};\n";
       for (int k = 0; k < 32; k++) 
       {       
          for (int i = 0; i < 5; i++)
      ...
      output += "\\fill[color="+RedColor+"] ("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+16)+")  rectangle ++(1,1);\n";
      output += "\\draw("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+16)+")  grid ++(1,1);\n";
      output += " \\node[align=center] at ("+(6*31+4+2.5)+","+(25*(mitmSolution.Rounds-round)+16.4)+") {\\textbf{\\huge - "+(allred)+"}};\n";
      output += "\\fill[color="+BlueColor+"] ("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+14.5)+")  rectangle ++(1,1);\n";
      output += "\\draw("+(6*31+4+4)+","+(25*(mitmSolution.Rounds-round)+14.5)+") grid ++(1,1);\n";   
      output += " \\node[align=center] at ("+(6*31+4+2.7)+","+(25*(mitmSolution.Rounds-round)+14.9)+") {\\textbf{\\huge - "+(allblue)+"}};\n";
      ...
      // DB after theta
        ...
        {       
          ...
          for (int j = 0; j < 5; j++)
          {
            if (mitmSolution.Cond[j][k][0] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(0%5+3*j)%5][0%5]+64)%32)+((0%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-0%5)+7+0.5)+") {\\textbf{\\Large 1}};\n";             
            if (mitmSolution.Cond[j][k][1] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(1%5+3*j)%5][1%5]+64)%32)+((1%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-1%5)+7+0.5)+") {\\textbf{\\Large 0}};\n";
            if (mitmSolution.Cond[j][k][2] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(2%5+3*j)%5][2%5]+64)%32)+((2%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-2%5)+7+0.5)+") {\\textbf{\\Large 0}};\n";             
            if (mitmSolution.Cond[j][k][3] == 1) 
              output += "\\node[align=center] at ("+(6*((k-rho[(4%5+3*j)%5][4%5]+64)%32)+((4%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-4%5)+7+0.5)+") {\\textbf{\\Large 1}};\n";
      ...
      // DB
        ...
        {       
          ...
          { 
            if (mitmSolution.Cond[j][k][0] == 1) 
              output += "\\node[align=center] at ("+(6*k+0%5+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-j)+0.5)+") {\\textbf{\\Large 1}};\n";
            if (mitmSolution.Cond[j][k][1] == 1) 
                output += "\\node[align=center] at ("+(6*k+1%5+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-j)+0.5)+") {\\textbf{\\Large 0}};\n";
            if (mitmSolution.Cond[j][k][2] == 1) 
              output += "\\node[align=center] at ("+(6*k+2%5+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-j)+0.5)+") {\\textbf{\\Large 0}};\n";
            if (mitmSolution.Cond[j][k][3] == 1) 
                output += "\\node[align=center] at ("+(6*k+4%5+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-j)+0.5)+") {\\textbf{\\Large 1}};\n";
          }
        }
