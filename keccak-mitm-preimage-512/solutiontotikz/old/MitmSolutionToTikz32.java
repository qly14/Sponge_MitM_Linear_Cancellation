    ...
    if (round == -1) {
	  ...
	  if (mitmSolution.DA[round+1][0][0][k][0] == 1 & mitmSolution.DA[round+1][0][0][k][1] == 1 & mitmSolution.DA[round+1][0][0][k][2] == 0) {
          ...
          if (mitmSolution.DA[round+1][1][2][k][0] == 0 & mitmSolution.DA[round+1][1][2][k][1] == 1 & mitmSolution.DA[round+1][1][2][k][2] == 1) {
            allred ++;
            output += "\\draw[line width=2pt, color=yellow]("+(6*((k-rho[2][1]+64)%32)+2)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.DA[round+1][1][2][k][0] == 1 & mitmSolution.DA[round+1][1][2][k][1] == 1 & mitmSolution.DA[round+1][1][2][k][2] == 0) {
            allblue ++;
            output += "\\draw[line width=2pt, color=black]("+(6*((k-rho[2][1]+64)%32)+2)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
      ...
      // DB after theta
        ...
        {       
          ...
          for (int i = 0; i < 5; i++)
            ...
            {
              if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 1) {
                output += "\\node[align=center] at ("+(6*((k-rho[((i+1)%5+3*j)%5][(i+1)%5]+64)%32)+(((i+1)%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-(i+1)%5)+7+0.5)+") {\\textbf{\\Large 0}};\n";
		output += "\\node[align=center] at ("+(6*((k-rho[((i+4)%5+3*j)%5][(i+4)%5]+64)%32)+(((i+4)%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-(i+4)%5)+7+0.5)+") {\\textbf{\\Large 1}};\n";
              }
              if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 0) {
                output += "\\node[align=center] at ("+(6*((k-rho[((i+1)%5+3*j)%5][(i+1)%5]+64)%32)+(((i+1)%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-(i+1)%5)+7+0.5)+") {\\textbf{\\Large 0}};\n";
		output += "\\node[align=center] at ("+(6*((k-rho[((i+4)%5+3*j)%5][(i+4)%5]+64)%32)+(((i+4)%5+3*j)%5)+0.5)+","+(25*(mitmSolution.Rounds-round)+(4-(i+4)%5)+7+0.5)+") {\\textbf{\\Large 1}};\n";
