  ...
  public String generate() {
    ...
    if (round == -1) {
	  ...
	  if (mitmSolution.Pi_init[0][0][k][0] == 1 & mitmSolution.Pi_init[0][0][k][1] == 1 & mitmSolution.Pi_init[0][0][k][2] == 0) {
          ...
          if (mitmSolution.Pi_init[1][2][k][0] == 0 & mitmSolution.Pi_init[1][2][k][1] == 1 & mitmSolution.Pi_init[1][2][k][2] == 1) {
            allred ++;
            output += "\\draw[line width=2pt, color=yellow]("+(6*((k-rho[2][1]+64)%64)+2)+","+(25*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
          }
          if (mitmSolution.Pi_init[1][2][k][0] == 1 & mitmSolution.Pi_init[1][2][k][1] == 1 & mitmSolution.Pi_init[1][2][k][2] == 0) {
            allblue ++;
